...
class SalesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'total_price' => ['type' => 'integer', 'length' => 5, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'quantity' => 1,
            'total_price' => 1,
            'created_at' => 1486757408,
            'updated_at' => 1486757408
        ],
    ];
}
